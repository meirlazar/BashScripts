...
BACKUPDIRS="Audio Books Installs Karaoke M_J Pictures Torah Videos" # SPECIFY WHICH SUB-DIRS TO BACKUP - CHANGE THIS
BACKUPSOURCE="/media/RAID0/MEDIA" # SPEFICY THE BACKUP SOURCE DIRECTORY 
